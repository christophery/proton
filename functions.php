...
function proton_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'proton' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'proton' ),
...
function proton_scripts() {
	...
	wp_enqueue_script( 'proton-main', get_template_directory_uri() . '/assets/built/casper.js', array('jquery'), _S_VERSION, true );
